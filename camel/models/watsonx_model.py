...
class WatsonXModel(OpenAICompatibleModel):
    r"""Constructor for IBM WatsonX backend with OpenAI compatibility.

    Args:
        model_type (Union[ModelType, str]): Model for which a backend is
            created, supported models can be found in the IBM WatsonX documentation:
            https://ibm.github.io/watsonx-ai-python-sdk/
        model_config_dict (Optional[Dict[str, Any]], optional): A dictionary
            that will be fed into:obj:`openai.ChatCompletion.create()`. If
            :obj:`None`, :obj:`WatsonXConfig().as_dict()` will be used.
            (default: :obj:`None`)
        api_key (Optional[str], optional): The API key for authenticating with
            the WatsonX service. (default: :obj:`None`)
        url (Optional[str], optional): The url to the WatsonX service.
            If not provided, "https://us-south.ml.cloud.ibm.com/ml/v1/" will be used.
            (default: :obj:`None`)
    ...
    def __init__(
        ...
        url = url or os.environ.get(
            "WATSONX_API_BASE_URL", "https://us-south.ml.cloud.ibm.com/ml/v1/"
        )
